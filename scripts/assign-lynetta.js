...
// Assign Lynetta Porter the requested services with specified commission rates
...
(async () => {
  const staff = await findStaffByFullName('Lynetta Porter');
  if (!staff) {
    console.error('Lynetta Porter not found.');
    process.exit(1);
  }

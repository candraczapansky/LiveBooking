...
export class RedisCache {
    ...
    async set(key, data, ttl = this.defaultTTL) {
        try {
            ...
            LoggerService.error('Cache set error', { key }, error);
        }
    }
    ...
    async get(key) {
        try {
            ...
            LoggerService.error('Cache get error', { key }, error);
            return null;
        }
    }
    // Delete cache
    async delete(key) {
        try {
            ...
            LoggerService.error('Cache delete error', { key }, error);
            return false;
        }
    }
    ...
    async deletePattern(pattern) {
        try {
            ...
            LoggerService.error('Cache pattern delete error', { pattern }, error);
            return 0;
        }
    }
    ...
    async setWithTags(key, data, tags, ttl = this.defaultTTL) {
        try {
            ...
            LoggerService.error('Cache set with tags error', { key, tags }, error);
        }
    }
    ...
    async invalidateByTags(tags) {
        try {
            ...
            LoggerService.error('Cache invalidate by tags error', { tags }, error);
            return 0;
        }
    }
    ...
    async warmCache(warmingData) {
        try {
            ...
            LoggerService.error('Cache warming error', {}, error);
        }
    }
    ...
    async getStats() {
        try {
            ...
            LoggerService.error('Cache stats error', {}, error);
            return null;
        }
    }
    // Cache analytics
    async trackCacheHit(key) {
        try {
            ...
            LoggerService.error('Cache hit tracking error', { key }, error);
        }
    }
    async trackCacheMiss(key) {
        try {
            ...
            LoggerService.error('Cache miss tracking error', { key }, error);
        }
    }
    async getCacheAnalytics() {
        try {
            ...
            LoggerService.error('Cache analytics error', {}, error);
            return {};
        }
    }
...
export function redisCached(ttl = 300, tags) {
...
export function redisCacheMiddleware(ttl = 300, tags) {
    return async (req, res, next) => {
        ...
        try {
            ...
            LoggerService.error('Redis cache middleware error', { key }, error);
            next();
        }
    };
}

...
async function runMigration() {
  try {
    ...
    `);
    console.log('✅ Created permission_categories table');
    ...
    `);
    console.log('✅ Created permission_group_mappings table');
    ...
    `);
    console.log('✅ Created user_permission_groups table');
    ...
    `);
    console.log('✅ Created user_direct_permissions table');
    ...
    `);
    console.log('✅ Inserted default permission categories');
    ...
    await db.execute(sql`
      ...
      ON CONFLICT (name) DO NOTHING;
    `);
    console.log('✅ Inserted default permission groups');
    ...
    if (adminGroupResult.rows.length > 0) {
      ...
      `);
      console.log('✅ Assigned all permissions to admin group');
      ...
      `);
      console.log('✅ Assigned admin user to admin group');
    }

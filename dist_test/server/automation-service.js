...
export class AutomationService {
     ...
     */
    async triggerAutomations(trigger, context, customTriggerName) {
     ...
     */
    async getActiveRules(trigger, customTriggerName) {
     ...
     */
    prepareTemplateVariables(context, client, service, staff, staffUser) {
     ...
     */
    async processAutomationRule(rule, client, variables) {
     ...
     */
    shouldSendAutomation(rule, client) {
     ...
     */
    async sendEmailAutomation(rule, client, subject, template) {
     ...
     * Send SMS automation
     */
    async sendSMSAutomation(rule, client, template) {
     ...
     */
    async triggerBookingConfirmation(context) {
     ...
     */
    async triggerAppointmentReminder(context) {
     ...
     */
    async triggerCancellation(context) {
     ...
     */
    async triggerAfterPayment(context) {
     ...
     */
    async triggerCustomAutomation(context, customTriggerName) {

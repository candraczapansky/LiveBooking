...
export class JotformIntegration {
    constructor(storage, fieldMappings = {}) {
     ...
     */
    async processSubmission(webhookData) {
        try {
     ...
     */
    mapToAppointmentData(fieldValues) {
        try {
     ...
     */
    async createAppointmentFromJotform(appointmentData) {
        const { startTime, endTime, notes, clientInfo, serviceInfo, staffInfo } = appointmentData;
     ...
     */
    async deleteJotformSubmission(formID, submissionID) {
        if (!JOTFORM_API_KEY) {

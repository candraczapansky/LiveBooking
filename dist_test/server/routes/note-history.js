...
export function registerNoteHistoryRoutes(app, storage) {
    // Get note history for a client
    app.get("/api/note-history/client/:clientId", asyncHandler(async (req, res) => {
    ...
    app.get("/api/note-history/appointment/:appointmentId", asyncHandler(async (req, res) => {
    ...
    app.get("/api/note-history", asyncHandler(async (req, res) => {
        const context = getLogContext(req);
    ...
    app.post("/api/note-history", validateRequest(insertNoteHistorySchema), asyncHandler(async (req, res) => {
        const context = getLogContext(req);
    ...
    app.put("/api/note-history/:id", validateRequest(updateNoteHistorySchema), asyncHandler(async (req, res) => {
    ...
    app.delete("/api/note-history/:id", asyncHandler(async (req, res) => {
        const noteId = parseInt(req.params.id);
        const context = getLogContext(req);

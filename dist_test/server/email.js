let appointmentConfirmationTemplate, appointmentReminderTemplate, followUpTemplate, birthdayTemplate, marketingCampaignTemplate, generateEmailHTML, generateEmailText, generateRawMarketingEmailHTML, htmlToText;
...
function isVerifiedSender(email) {
    return VERIFIED_SENDERS.some(sender => email.toLowerCase() === sender.toLowerCase());
}
...
export function createAppointmentReminderEmail(clientEmail, clientName, appointmentDate, appointmentTime, serviceName, salonEmail, additionalData) {
    const templateData = {
        clientName,
        clientEmail,
        serviceName,
...
export function createMarketingCampaignEmail(clientEmail, clientName, subject, content, salonEmail, trackingToken, additionalData) {
...
export function createAccountUpdateEmail(clientEmail, clientName, updateType, details, salonEmail) {
    const templateData = {
        clientName,
        clientEmail,
        updateType,
